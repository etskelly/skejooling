...
CREATE UNIQUE INDEX "Clients_email_tenantId_key" ON "Clients"("email", "tenantId") WHERE email IS NOT NULL;
CREATE UNIQUE INDEX "Clients_phone_tenantId_key" ON "Clients"("phone", "tenantId") WHERE phone IS NOT NULL;
...
-- AddForeignKey
ALTER TABLE "Resources" ADD CONSTRAINT "Resources_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Services" ADD CONSTRAINT "Services_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Clients" ADD CONSTRAINT "Clients_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Appointments" ADD CONSTRAINT "Appointments_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Holidays" ADD CONSTRAINT "Holidays_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
